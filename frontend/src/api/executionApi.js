...
export const executionApi = {
  ...
  updateAssignment: (id,payload) => api(`/api/v2/execution/tasks/${id}/assignment`, { method:"PATCH", body:JSON.stringify(payload) }),
  ...
  updateTemplate: (id,payload) => api("/api/v2/execution/templates/" + id, { method:"PUT", body:JSON.stringify(payload) }),
  updateTemplateStatus: (id,active) => api("/api/v2/execution/templates/" + id + "/status", { method:"PATCH", body:JSON.stringify({ active }) }),
  deleteTemplate: id => api("/api/v2/execution/templates/" + id, { method:"DELETE" }),
};
