import { Activity, CalendarDays, Check, CircleAlert, Clock3, Layers3, MapPin, Pencil, RotateCcw, ShieldCheck, Truck, UserPlus, UsersRound } from "lucide-react";
...
export function ProjectDetailModal({ projectId, references, templates = [], user, onClose, onEdit, onChanged, onDeleted }) {
  ...
  const detailTabs = [["overview", CalendarDays, "Overview"], ...(!["supervisor", "internal_employee"].includes(user.role) ? [["template-review", Layers3, "Template Review"], ["dependencies", Layers3, "Dependencies"], ["external-gates", ShieldCheck, "External Gates"]] : []), ["team", UsersRound, "Team"], ["vendors", Truck, "Vendors"], ["activity", Activity, "Activity"]];
